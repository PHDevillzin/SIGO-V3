    ...
    try {
        ...
        if (req.method === 'PUT') {
            ...
            const body = req.body;
             ...
             // Dynamic update query builder could be complex, for now we update all fields or specific ones.
             // A simpler approach for this prototype is updating all relevant fields.
