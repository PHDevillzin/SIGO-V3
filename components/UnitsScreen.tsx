...
const parsedUnits: Unit[] = rawData.split('\n').map((line, index) => {
...
const UnitsScreen: React.FC = () => {
    const [units, setUnits] = useState<Unit[]>(parsedUnits);
