...
const PeriodoSolicitacaoScreen: React.FC = () => {
      ...
      return (
        <div key={period.id} className="bg-white rounded-lg shadow-md p-6 border-l-4 border-[#0E4F8F] hover:shadow-lg transition-shadow group relative">
            <div className="flex justify-between items-start mb-4">
                <div>
                    <h3 className="text-lg font-bold text-gray-800">{period.tipoServico}</h3>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <h1 className="text-2xl font-bold text-gray-800">Período de Solicitação</h1>
      </div>
...
export default PeriodoSolicitacaoScreen;
