...
const PeriodoAprovacaoScreen: React.FC<PeriodoAprovacaoScreenProps> = ({ profiles }) => {
  ...
  const renderCard = (period: ApprovalPeriod) => {
      ...
      return (
        <div key={period.id} className="bg-white rounded-lg shadow-md p-6 border-l-4 border-[#0E4F8F] hover:shadow-lg transition-shadow group relative">
            <div className="flex justify-between items-start mb-4">
                <div>
                    <h3 className="text-lg font-bold text-gray-800">{period.tipoAprovador}</h3>
